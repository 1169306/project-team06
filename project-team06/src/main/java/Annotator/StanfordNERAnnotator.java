...
public class StanfordNERAnnotator extends JCasAnnotator_ImplBase {
  ...
  /**
   * The method initializes PosTagNamedEntityRecognizer to perform name entity recognition.
   * 
  ...
  public void process(JCas aJCas) throws AnalysisEngineProcessException {
    FSIterator<Annotation> questionIter = aJCas.getAnnotationIndex(Question.type).iterator();
